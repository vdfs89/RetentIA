...
- **MLP @0.36 threshold:** Accuracy 0.6558, Precision 0.4295, Recall 0.9037, F1 0.5823
...
## 8. Decision
Score above threshold (0.36) → customer enters retention queue for human review (offer, call, discount). Threshold derived from cost minimization on validation set, not fixed at 0.5.
